					...
					<div class="box-body">
						<div class="form-group">
		                  ...
		                  <select class="form-control" name="parent">
		                    ...
		                    {!! $objCategory->create_select_category($parent_cate, 0, '', old('parent')) !!}
		                  </select>
		                </div>
						<div class="form-group">
		                ...
		                <div class="form-group">
		                  ...
		                  <input class="form-control" type="text" placeholder="Icon" name="icon" id="icon" value="{{ old('icon') }}">
		                </div>
		                <div class="form-group">
		                  <label for="order">Order</label>
		                  <input class="form-control" type="text" placeholder="Order" name="order" id="order" value="{{ old('order') }}">
		                </div>
		                <div class="form-group">
