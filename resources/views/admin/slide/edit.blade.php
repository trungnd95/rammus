@extends('admin.main')
@section('title', 'Khu vực quản trị của website Rammus | Edit slide')
@section ('content')
...
<section class="content">
	...
	<div class="col-lg-12">
     ...
     <?php $id = $slide['id']; ?>
	<form action="{{ route('admin.system.getSlideEdit', ['id' => $id]) }}" method="POST" enctype="multipart/form-data">
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="box box-success">
				...
				<div class="box-body">						
					<div class="form-group">
			         ...
			         @if ($slide['image'] != '')
			         	{!! '<div class="row"><div class="col-xs-6 col-md-3"><a href="#" class="thumbnail" id="display-img"><img src="'. url('public/teamplate/img/slider/' . $slide['image']).'" class="img-avata-upload" /></a></div></div>' !!}
			         @endif
			        </div>
	                <div class="form-group">
	                ...
	                <div class="form-group">
	                  ...
	                  <textarea class="form-control" rows="6" placeholder="Content ..." name="content" id="content"  style="height: 600px;">{{ old('content', isset($slide['content']) ? $slide['content'] : null) }}</textarea>
                	</div>  
				</div>
