...
<div class="register-box">
  <div class="register-box-body">
    ...
    <div class="social-auth-links text-center">
      <p>- OR -</p>
      <a href="{!! route('social.login',['facebook']) !!}" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign up using
        Facebook</a>
      <a href="{{ route('social.login',['google']) }}" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Sign up using
        Google+</a>
    </div>
  </div>
  <!-- /.form-box -->
